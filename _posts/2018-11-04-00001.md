...
$ autoreconf
$ ./configure --disable-shared --prefix=/tmp/kf
$ make && make install
$ strip /tmp/kf/bin/*
$ cp /tmp/kf/bin/* $HOME/bin/   # ${HOME}/bin 已经配置在了 PATH 中
$ popd
```
...
$ make menuconfig               # 必需/其它自定义配置
        ...
        #     CONFIG_ARCH_TEXT_VBASE    # 必需/内存布局/自定义
        #     CONFIG_ARCH_DATA_VBASE    # 必需/内存布局/自定义
        #     CONFIG_ARCH_HEAP_VBASE    # 必需/内存布局/自定义
