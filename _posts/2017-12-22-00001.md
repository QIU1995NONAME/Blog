...
Number  Start (sector)    End (sector)  Size       Code  Name
   ...
   2         1050624         4196351   1.5 GiB     8300  Linux filesystem
   3         4196352        12584959   4.0 GiB     8200  Linux swap
   4        12584960        67108830   26.0 GiB    8300  Linux filesystem
```
...
(Fedora Live) $ sudo mkswap     /dev/sda3
(Fedora Live) $ sudo mkfs.xfs   /dev/sda4
(Fedora Live) $ cd /mnt
(Fedora Live) $ sudo mkdir gentoo
(Fedora Live) $ sudo mount /dev/sda4 gentoo
...
├─sda1        8:1    0  512M  0 part /mnt/gentoo/boot/efi
├─sda2        8:2    0  1.5G  0 part /mnt/gentoo/boot
├─sda3        8:3    0    4G  0 part [SWAP]
└─sda4        8:4    0   26G  0 part /mnt/gentoo
```
...
# 选择一个 profile (default/linux/amd64/17.0/desktop/plasma/systemd)
...
在使用了 Fedora 的配置 (来自LiveCD) 基础上，再修改配置。
...
/dev/sda4 /         xfs   defaults,noatime             0 0
```
...
(gentoo) $ sudo emerge -a plasma
(gentoo) $ sudo emerge -a plasma-meta
(gentoo) $ sudo emerge -a konsole
(gentoo) $ sudo emerge -a kde-apps/dolphin

(gentoo) $ emerge -a wqy-bitmapfont
(gentoo) $ emerge -a wqy-microhei
```
